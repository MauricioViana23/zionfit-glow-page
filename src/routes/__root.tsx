...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Acorde sem inchaço e com energia limpa em 30 segundos por dia. Shot matinal sabor Pink Lemonade com ingredientes naturais." },
